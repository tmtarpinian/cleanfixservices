        ...
        <div className="row m-0 home-banner-row">
          <div className="col pt-4 m-md-auto">
            <div className="d-flex flex-row justify-content-center align-items-center mb-0">
              fix
              <i class="fa-solid fa-2xs fa-star mx-1 shaking-icon"></i>
              organize
              <i class="fa-solid fa-2xs fa-star mx-1 shaking-icon"></i>
              clean
            </div>
            ...
            <div className="d-flex justify-content-center mt-3">
                <Link to={ FACEBOOK_PAGE } className="btn btn-lg btn-primary" role="button">Book Now</Link>
            </div>
          </div>
          <div className="d-none d-md-block col p-0">
            {/* image size is 1066x600 */}
            <img src={checklist} class="img-fluid" alt="an axe in a tree stump"/>
          </div>
        </div>
      </div>
